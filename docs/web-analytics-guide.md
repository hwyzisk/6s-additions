...
For earlier versions of `@vercel/analytics`, update your `astro.config.mjs`:
...
For framework integrations that require the package, use your package manager of choice to add the `@vercel/analytics` package to your project:
